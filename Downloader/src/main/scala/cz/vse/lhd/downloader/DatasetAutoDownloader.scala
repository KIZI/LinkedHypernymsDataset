...
import cz.vse.lhd.downloader.DatasetAutoDownloader.Exceptions.NoRemoteFileForDatasetPattern

import scala.util.{Failure, Try}

trait DatasetAutoDownloader extends DatasetDownloader {
